...
public class TaskFormBean implements java.io.Serializable
{
	...
	private static final long	serialVersionUID	= 1734702261419226977L;
	...
	private String				idWrkrCreate		= "ACTS9999";

	private Timestamp			tsCreate;
	private Timestamp			tsUpdate;
	private Timestamp			tsAssigned;

	private String				idWrkrUpdate		= "ACTS9999";
	private int					createMo;
	private int					createYr;
	 ...
	 * 
	 * @param nmCustomerFirst
	 *            The nmCustomerFirst to set
	 */
	 ...
	 * 
	 * @param nmCustomerLast
	 *            The nmCustomerLast to set
	 */
	 ...
	 *            the createMo to set
	 */
	public void setCreateMo(int createMo)
	{
		this.createMo = createMo;
	}

	/**
	 * @return the createYr
	 */
	public int getCreateYr()
	{
		return createYr;
	}
	 ...
	 *            the createYr to set
	 */
	public void setCreateYr(int createYr)
	{
		this.createYr = createYr;
	}

	/**
	 * @return the tsAssigned
	 */
	public Timestamp getTsAssigned()
	{
		return tsAssigned;
	}

	/**
	 * @param tsAssigned the tsAssigned to set
	 */
	public void setTsAssigned(Timestamp tsAssigned)
	{
		this.tsAssigned = tsAssigned;
	}
