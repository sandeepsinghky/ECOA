...
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/browsercheck.js"></script>
<script>
	if(!is.ie){
	...
	function validateCity(form) {
		...
		if((window.location.href).indexOf("clerkOfCourtSearch/1.htm") >= 0)
		{
			form.action = "${pageContext.request.contextPath}/clerkOfCourtList/1.htm";
		}
		else {
			form.action = "${pageContext.request.contextPath}/clerkOfCourtList/2.htm";
		}	
...
<form name="Search" method="post"  onSubmit="return validateCity(document.Search)">	
  <div id="content">
		<div class="gutter">
			<h2> Clerk of Court Search</h2>
			<hr>			
			<p>Search: Clerk of Court Addresses/Phone Numbers for North Carolina</p>
			...
			<table width="60%" border="0">
				...
				<tr>
					<td width="23%">City:</td>
					<td width="77%" height="30">
						<input type="text" name="strCity" size="25" maxlength="25" value="">
						<input type="hidden" name="srcPage" value="Search">
					</td>
				</tr>
				<tr>
				...
				<tr>						
					<td align="left"><input type="submit" value="Search"  onclick="return validateCity(this)"/></td> 				
				<tr>
					<td width="23%">&nbsp;</td>
					<td width="77%">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4">To obtain a current address for a local county Clerk of Court complete the fields on the form and click	&quot;Search&quot;.</td>
				</tr>
				<tr>
					<td width="23%">&nbsp;</td>
					<td width="77%">&nbsp;</td>
