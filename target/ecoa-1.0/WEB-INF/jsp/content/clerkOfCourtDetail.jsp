...
function newSearch()
{
	...
	{
		location.href="${pageContext.request.contextPath}/clerkOfCourtSearch/1.htm";
	}
	else if((window.location.href).indexOf("clerkOfCourtList/2.htm") >= 0)
	{	location.href="${pageContext.request.contextPath}/clerkOfCourtSearch/2.htm"; }
	
	else if((window.location.href).indexOf("clerkOfCourtDetail/1.htm") >= 0)
	{
		location.href="${pageContext.request.contextPath}/clerkOfCourtSearch/1.htm";
	}
	else if((window.location.href).indexOf("clerkOfCourtDetail/2.htm") >= 0)
	{
		location.href="${pageContext.request.contextPath}/clerkOfCourtSearch/2.htm";
	}
}
...
<table width="100%" border="0">
		...
		<tr>
			<td bgcolor="#FFFFFF" colspan="2">Please find below a detailed view of the local ${fipsType.equals('CORT') ? "Clerk of Court " :"Child Support Enforcement Agency"} you selected.
			</td>
		</tr>
	</table>
	<br>
	<table width="80%" border="0">
		...
		<tr>
			<td width="60%">Name of ${fipsType.equals('CORT') ? "Clerk of Court: " : "Child Support Enforcement Agency:"}</td>
